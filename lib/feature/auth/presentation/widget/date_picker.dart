...
class AppDatePicker extends StatefulWidget {
  ...
  AppDatePicker.upperLimit({super.key, this.upperLimit, required this.dateChangedCallback});
  AppDatePicker.lowerLimit({super.key, this.lowerLimit, required this.dateChangedCallback});
...
class _AppDatePickerState extends State<AppDatePicker> {
  DateTime currentDate = DateTime.parse('2000-01-01T23:00:00.000').toLocal();
  DateTime today = DateTime.now().toLocal();

  String get _yesterDay {
    int yDay = currentDate.day - 1 > 0 ? currentDate.day - 1 : DateUtils.getDaysInMonth(currentDate.year, currentDate.month);
  ...
  String get _nextDay {
    int numOfDays = DateUtils.getDaysInMonth(currentDate.year, currentDate.month);
  ...
  Widget _dates(String yesterData, String todayData, String tomorrowData, PickerDateComponent comp) {
    return Expanded(
      child: Column(
          ...
          InkWell(
            ...
            onTap: () {
              ...
              if (comp == PickerDateComponent.day) {
                ...
                int maxDays = DateUtils.getDaysInMonth(currentDate.year, lastMonth);
                DateTime tempDate = DateTime(currentDate.year, lastMonth, maxDays < currentDate.day ? maxDays : currentDate.day);
                ...
                DateTime tempDate = DateTime(currentDate.year - 1, currentDate.month, currentDate.day);
          ...
          InkWell(
            ...
            onTap: () {
              ...
              if (comp == PickerDateComponent.day) {
                ...
                setState(() {
                  DateTime tempDate = DateTime(currentDate.year, nextMonth, maxDays < currentDate.day ? maxDays : currentDate.day);
                  if (uLimit == null) {
                    currentDate = tempDate;
                    widget.dateChangedCallback(currentDate);
                  } else if (tempDate.compareTo(uLimit) <= 0) {
